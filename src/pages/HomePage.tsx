  ...
  return (
    <div className="min-h-screen">
      <div className="w-screen bg-gradient-to-br from-indigo-800 to-orange-800 pt-40 pb-40 min-h-screen">
        ...
        <p className="text-center font-medium text-gray-200 text-xl mt-3">Gaze upon my stuff! Or else!</p>

        <div className="flex flex-row mt-10">
          
          <div className="mx-auto my-10 py-10 bg-gray-800 shadow-lg rounded-4xl p-8 w-7/16 text-center">
            <p className="text-white text-3xl text-center font-bold">Samuel Thompson</p>
            <p className="text-gray-300 text-lg text-center font-semibold mt-4">B.S. Software Engineering <br/> SUNY College at Oswego</p>
            <div className="flex flex-row py-10">

              {/* Photo */}
              <div className="flex flex-col w-1/2 space-y-4 mx-2">
                <img src={mePNG}/>
                <p className="text-white text-lg font-medium">"Hey, that's me!" <br/> - Sam Thompson, 2025</p>
              </div>
              {/* Info */}
              <div className="flex flex-col w-1/2 space-y-4 mx-2">
                {/* Languages */}
                ...
                <div className="text-center text-gray-300 text-lg font-medium mx-auto">
                  ...
                  <p className="text-gray-300 font-thin">
                    ...
                    I also like to make things that help people solve their own problems. 
                    If you've got a computer problem, hardware or software, let me help solve it.
                  </p>
                </div>
                {/* Contact */}
                <div className="text-center text-gray-300 text-lg font-medium">
                  ...
                  <table>
                    <tr>
                      ...
                      <td>
                        <p className="text-right font-thin">samthompson1818@gmail.com</p>
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        <p className="text-right ml-auto font-thin">+1 (315) 200-9977</p>
                      </td>
                    </tr>
                    <tr>
                      <td>
