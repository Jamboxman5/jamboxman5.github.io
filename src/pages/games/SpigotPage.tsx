  ...
  return (
    <div className="themed-bg pt-40 pb-40 min-h-screen">
      ...
      <div className="flex flex-col space-y-4">
        ...
        <h1 className="text-center font-bold themed-text">Spigot Plugins</h1>
        <p className="text-center font-semibold text-xl themed-text w-8/16 mx-auto mt-6">
          A collection of my Minecraft multiplayer server modifications,
          implemented using the Spigot API, Vault API, and various other
          dependencies. Some of these were developed with public use in mind,
          others specifically to be used by my own server, and are tailored as
          such.
        </p>
