    ...
    return (
        <div className="mx-auto my-10 py-10 bg-gray-800 shadow-lg rounded-4xl p-8 w-8/10 lg:max-w-7/16 lg:max-w-7/16 p-4 text-center flex flex-col">
            ...
            <p className="text-xl font-semibold text-gray-300 w-5/6 mx-auto flex-1 flex items-center justify-center">
              This plugin adds a simplified version of the Red Dead Redemption II style of hunting & fishing.
              Caught fish & killed animals will drop pelts or carcasses rated between one & three stars.
              The star rating may be affected by the tool used & its enchantments.
            </p>
