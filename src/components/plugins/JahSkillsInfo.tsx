export default function JahSkillsInfo() {
    return (
        <div className="mx-auto my-10 py-10 bg-gray-800 shadow-lg rounded-4xl p-8 w-8/10 lg:max-w-7/16 lg:max-w-7/16 p-4 text-center">
            
            <p className="text-3xl font-bold text-gray-100 mb-4">
              - JahSkills -
            </p>

            <p className="text-xl font-semibold text-gray-300 w-5/6 mx-auto">
              This plugin is meant to add RPG style skills & perks to the game. 
